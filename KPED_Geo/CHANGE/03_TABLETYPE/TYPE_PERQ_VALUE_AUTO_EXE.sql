IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'PROC_GET_PROPORTIONATE_TAX_VALUE')
BEGIN
DROP PROCEDURE PROC_GET_PROPORTIONATE_TAX_VALUE
END
GO

IF EXISTS(SELECT NAME FROM SYS.PROCEDURES WHERE NAME = 'PROC_GET_PERQUISITE_TAX_VALUE')
BEGIN
DROP PROCEDURE PROC_GET_PERQUISITE_TAX_VALUE
END
GO


IF EXISTS(SELECT NAME FROM SYS.TYPES WHERE NAME = 'TYPE_PERQ_VALUE_AUTO_EXE')
BEGIN
DROP TYPE TYPE_PERQ_VALUE_AUTO_EXE
END
GO
