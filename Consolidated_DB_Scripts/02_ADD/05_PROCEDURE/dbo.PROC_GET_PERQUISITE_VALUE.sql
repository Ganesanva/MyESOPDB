...
CREATE PROCEDURE [dbo].[PROC_GET_PERQUISITE_VALUE]
...
BEGIN  
 SET NOCOUNT ON;   
   DECLARE @ISPERQUSITE_VAL TINYINT,@ISROPORTIONATE_VAL  TINYINT,@EXCEPTFOR_PERQUISITE NVARCHAR(50)  
    ,@EXCEPTFOR_PROPORTIONATE VARCHAR(50),@MN_VALUE INT,@MX_VALUE INT,@INSTRUMENT_ID BIGINT ,@EMPLOYEE_ID  VARCHAR(50),@GRANTOPTIONID VARCHAR(50) ,@GRANTDATE  VARCHAR(200) ,
	@VESTINGDATE VARCHAR(200), @EXERCISE_DATE  DATETIME    
    ...
    ,@SQL NVARCHAR(MAX),@result NUMERIC(20,9) ,@EXERCISEDATE DATETIME,@EMPLOYEE_STATUS INT , @EMPLOYEEID VARCHAR(50),@EMPLOYEE_COUNTRY_ID INT,@EVENTOFINCIDENCE INT,
	@GRANTED_OPTION NUMERIC(18,9),@PERQCOUNT VARCHAR(500)   
	...
	,@SHARE_ARISING_APPR_VAL NUMERIC(20,9),@ROUNDING_UP TINYINT,@FRACTION_PAID_CASH TINYINT ,@TEMP_EXERCISEDQUANTITY NUMERIC(18,9), @TEMP_SHARE_VALUE NUMERIC(18,9), 
	@GRANTLEG_ID BIGINT,@PRE_EXERCISED_QTY NUMERIC(18,9),@PRE_CALCULATED_SHARE_APP_VAL NUMERIC(18,9),@EXERCISENO NVARCHAR(50)
    ,@TOTAL_CASHPAYOUT NUMERIC(18,9), @CASHPAYOUT_VALUE NUMERIC(18,9)   , @EXERCISE_AMOUNT_PAYABLE NUMERIC(20,9) ,@OptionRatioMultiplier BIGINT,@OptionRatioDivisor BIGINT 
    ,@ISAPPLICABLE INT
  -- CREATE TEMP TABLE --  
  CREATE TABLE #TEMP_EMPLOYEE_DETAILS  
    ...
    (    
       ...
       ,TOTAL_EXERCISEDQUANTITY  NUMERIC(18,9),SHARE_APPRECIATION_VALUE NUMERIC(20,9),CALCULATED_SHARE_APP_VAL NUMERIC(18,9),CASHPAYOUT_VALUE numeric(18,9),TOTAL_CASHPAYOUT_VALUE  numeric(18,9),EXERCISENO NVARCHAR(50)  
    )   
     CREATE TABLE #TEMP_PERQUISITE_DETAILS  
    (  
       ID INT IDENTITY(1,1) NOT NULL,INSTRUMENT_ID BIGINT,EMPLOYEE_ID VARCHAR(50),EXERCISE_PRICE NUMERIC(18,9),OPTION_VESTED NUMERIC(18,9),EXERCISE_DATE DATETIME,
	   PERQ_VALUE NUMERIC(20,9),
	   EVENTOFINCIDENCE INT,FMV_VALUE NUMERIC(18,9),OPTION_EXERCISED NUMERIC(18,9),GRANTED_OPTIONS NUMERIC(18,9)  
    ...
    (  
       ID INT IDENTITY(1,1) NOT NULL,INSTRUMENT_ID BIGINT ,EMPLOYEE_ID VARCHAR(50),EXERCISE_PRICE NUMERIC(18,9),OPTION_VESTED NUMERIC(18,9),EXERCISE_DATE DATETIME,
	   PERQ_VALUE NUMERIC(20,9),EVENTOFINCIDENCE INT,FMV_VALUE NUMERIC(18,9),OPTION_EXERCISED NUMERIC(18,9),GRANTED_OPTIONS NUMERIC(18,9)  
      ,GRANTOPTIONID VARCHAR(50)NUll,GRANTDATE VARCHAR(200) NUll,VESTINGDATE VARCHAR(200)NUll,GRANTLEGSERIALNO BIGINT,FROM_DATE DATETIME,TO_DATE DATETIME,
	  TEMP_EXERCISEID BIGINT,SHARE_APPRECIATION_VALUE NUMERIC(20,9),EXERCISE_AMOUNT_PAYABLE  NUMERIC(20,9) 
       ,CASHPAYOUT_VALUE  NUMERIC(18,9),STOCK_VALUE NUMERIC(20,9)  
    )  
